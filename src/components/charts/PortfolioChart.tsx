    ...
    return (
        <Card className="portfolio-chart">
            ...
            <CardContent className="portfolio-chart__content">
                {data.length > 1 ? <ResponsiveContainer width="100%" height={300}>
                    ...
                    <div className="portfolio-chart__empty">
                        <span>{data.length === 1 ? 'Recopilando histórico…' : 'Aún no hay histórico suficiente'}</span>
                        <small>Se necesitan al menos dos puntos para dibujar la evolución.</small>
                    </div>
                )}
