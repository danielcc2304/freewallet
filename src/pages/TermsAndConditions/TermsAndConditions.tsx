            ...
            <div className="terms__container">
                ...
                <section className="terms__section">
                    ...
                    <ul>
                        ...
                        <li><strong>Analítica técnica:</strong> FreeWallet puede utilizar servicios de analítica técnica y medición agregada de uso, como Vercel Analytics, cuyos proveedores pueden tratar datos técnicos mínimos de navegación y rendimiento, tales como dirección IP, metadatos del navegador, páginas visitadas, eventos de navegación y métricas agregadas de funcionamiento, conforme a sus propias políticas.</li>
